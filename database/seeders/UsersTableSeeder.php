...
class UsersTableSeeder extends Seeder
{
    public function run()
    {
        $arrPermissions = [
            ...
            [
                "name" => "Manage Reimbursement Type",
                "guard_name" => "web",
                "created_at" => date('Y-m-d H:i:s'),
                "updated_at" => date('Y-m-d H:i:s'),
            ],
        ...
        $AccountsRole->givePermissionTo($AccountsPermission);
        ...
        $data = [
            ...
            ['name' => 'theme_color', 'value' => 'theme-3', 'created_by' => 1, 'created_at' => now(), 'updated_at' => now()]
        ];
