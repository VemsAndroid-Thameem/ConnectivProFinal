...
class User extends Authenticatable implements MustVerifyEmail
{
        ...
        $defaultTemplate = [
            ...
            'contract' => [
                ...
                'lang' => [
                    ...
                    <p><span style="font-family: sans-serif;">{app_name}</span></p>',
            ...
            'reimbursement' => [
                ...
                'lang' => [
                    'ar' => '<p><span style="font-family: sans-serif;"><strong>مرحبا </strong>{ reimbursement_employee } </span></p>
                    <p><span style="font-family: sans-serif;"><strong><strong>العقد :</strong> </strong>{ reimbursement_subject } </span></p>
                    <p><strong><span style="font-family: sans-serif;">S</span></strong><span style="font-family: sans-serif;"><strong>تاريخ البدء</strong>: { reimbursement_start_date } </span></p>
                    <p><span style="font-family: sans-serif;"><strong>تاريخ الانتهاء</strong>: { reimbursement_end_date } </span></p>
                    <p><span style="font-family: sans-serif;">اتطلع للسمع منك. </span></p>
                    <p><strong><span style="font-family: sans-serif;">Regards Regards ، </span></strong></p>
                    <p><span style="font-family: sans-serif;">{app_name}</span></p>',
                    'da' => '<p><span style="font-family: sans-serif;"><strong>Hej </strong>{ reimbursement_employee } </span></p>
                    <p><span style="font-family: sans-serif;"><strong>Aftaleemne:</strong> { reimbursement_subject } </span></p>
                    <p><strong><span style="font-family: sans-serif;">S</span></strong><span style="font-family: sans-serif;"><strong>tart-dato</strong>: { reimbursement_start_date } </span></p>
                    <p><span style="font-family: sans-serif;"><strong>Slutdato</strong>: { reimbursement_end_date } </span></p>
                    <p><span style="font-family: sans-serif;">Ser frem til at høre fra dig. </span></p>
                    <p><strong><span style="font-family: sans-serif;">Kærlig hilsen </span></strong></p>
                    <p><span style="font-family: sans-serif;">{app_name}</span></p>',
                    'de' => '<p><span style="font-family: sans-serif;"><strong><strong> </strong></strong>{reimbursement_employee} </span></p>
                    <p><span style="font-family: sans-serif;"><strong>Vertragssubjekt:</strong> {reimbursement_subject} </span></p>
                    <p><span style="font-family: sans-serif;"><strong>tart-Datum</strong>: {reimbursement_start_date} </span></p>
                    <p><span style="font-family: sans-serif;"><strong>Sluttdato </strong>:{reimbursement_end_date} </span></p>
                    <p><span style="font-family: sans-serif;">Freuen Sie sich auf die von Ihnen zu h&ouml;renden Informationen. </span></p>
                    <p><strong><span style="font-family: sans-serif;"><span style="font-family: sans-serif;">-Regards, </span></span></strong></p>
                    <p><span style="font-family: sans-serif;">{app_name}</span></p>',
                    'en' => '<p><span style="font-family: sans-serif;"><strong>Hi </strong>{reimbursement_employee} </span></p>
                    <p><span style="font-family: sans-serif;"><strong>Reimbursement Value of </strong> {reimbursement_value} has been requested for claim successfully.</span></p>
                    <p><strong><span style="font-family: sans-serif;"></span></strong><span style="font-family: sans-serif;"><strong>The Requested Dates are</strong>: {reimbursement_start_date} to {reimbursement_end_date}</span></p>
                    <p><strong><span style="font-family: sans-serif;"></span></strong><span style="font-family: sans-serif;">Your <strong>Status </strong>for Reimbursement is: <strong>{reimbursement_status}</strong></span></p>
                    <p><span style="font-family: sans-serif;">You will be Notified when the status changes. </span></p>
                    <p><strong><span style="font-family: sans-serif;">Kind Regards, </span></strong></p>
                    <p><span style="font-family: sans-serif;">{app_name}</span></p>',
                    'es' => '<p><span style="font-family: sans-serif;"><strong><strong>Hi </strong></strong>{reimbursement_employee} </span></p>
                    <p><span style="font-family: sans-serif;"><strong><strong>de contrato:</strong> </strong>{reimbursement_subject} </span></p>
                    <p><strong><span style="font-family: sans-serif;"><span style="font-family: sans-serif;">S</span></span></strong><span style="font-family: sans-serif;"><strong>tart Date</strong>: {reimbursement_start_date} </span></p>
                    <p><span style="font-family: sans-serif;"><strong>Fecha de finalizaci&oacute;n</strong>: {reimbursement_end_date} </span></p>
                    <p><span style="font-family: sans-serif;">Con ganas de escuchar de usted. </span></p>
                    <p><strong><span style="font-family: sans-serif;"><span style="font-family: sans-serif;">Regards de tipo, </span></span></strong></p>
                    <p><span style="font-family: sans-serif;">{reimbursement_name}</span></p>',
                    'fr' => '<p><span style="font-family: sans-serif;"><strong><strong> </strong></strong>{ reimbursement_employee } </span></p>
                    <p><span style="font-family: sans-serif;"><strong>Objet du contrat:</strong> { reimbursement_subject } </span></p>
                    <p><strong><span style="font-family: sans-serif;">S</span></strong><span style="font-family: sans-serif;"><strong>Date de d&eacute;but</strong>: { reimbursement_start_date } </span></p>
                    <p><span style="font-family: sans-serif;"><strong>Date de fin</strong>: { reimbursement_end_date } </span></p>
                    <p><span style="font-family: sans-serif;">Vous avez h&acirc;te de vous entendre. </span></p>
                    <p><strong><span style="font-family: sans-serif;">Kind Regards </span> </strong></p>
                    <p><span style="font-family: sans-serif;">{app_name}</span></p>',
                    'it' => '<p><span style="font-family: sans-serif;"><strong>Ciao </strong>{reimbursement_employee} </span></p>
                    <p><span style="font-family: sans-serif;"><strong>Oggetto Contratto:</strong> {reimbursement_subject} </span></p>
                    <p><strong><span style="font-family: sans-serif;">S</span></strong><span style="font-family: sans-serif;"><strong>Data tarte</strong>: {reimbursement_start_date} </span></p>
                    <p><span style="font-family: sans-serif;"><strong>Data di fine</strong>: {reimbursement_end_date} </span></p>
                    <p><span style="font-family: sans-serif;">Non vedo lora di sentire da te. </span></p>
                    <p><strong><span style="font-family: sans-serif;">Kind indipendentemente, </span></strong></p>
                    <p><span style="font-family: sans-serif;">{app_name}</span></p>',
                    'ja' => '<p><span style="font-family: sans-serif;"><span style="font-family: sans-serif;"><strong>ハイ </strong>{reimbursement_employee} </span></span></p>
                    <p><span style="font-family: sans-serif;"><strong>契約件名:</strong> {契約対象} </span></p>
                    <p><strong><strong><span style="font-family: sans-serif;">S</span></strong><span style="font-family: sans-serif;"><strong>tart Date</strong>: </span></strong><span style="font-family: sans-serif;">{reimbursement_start_date}</span><span style="font-family: sans-serif;"> </span></p>
                    <p><span style="font-family: sans-serif;"><strong>終了日</strong>: {reimbursement_end_date} </span></p>
                    <p><span style="font-family: sans-serif;">お客様から連絡をお待ちしています。 </span></p>
                    <p><strong><span style="font-family: sans-serif;"><span style="font-family: sans-serif;">クインド・レード </span></span></strong></p>
                    <p><span style="font-family: sans-serif;">{app_name}</span></p>',
                    'nl' => '<p><span style="font-family: sans-serif;"><strong>Hi </strong>{ reimbursement_employee } </span></p>
                    <p><span style="font-family: sans-serif;"><strong>reimbursementonderwerp:</strong> { reimbursement_subject } </span></p>
                    <p><strong><span style="font-family: sans-serif;">S</span></strong><span style="font-family: sans-serif;"><strong>tart Date</strong>: { reimbursement_start_date } </span></p>
                    <p><span style="font-family: sans-serif;"><strong>Einddatum</strong>: { reimbursement_end_date } </span></p>
                    <p><span style="font-family: sans-serif;">Ik kijk ernaar uit om van u te horen. </span></p>
                    <p><strong><span style="font-family: sans-serif;">Soort Regards, </span></strong></p>
                    <p><span style="font-family: sans-serif;">{app_name}</span></p>',
                    'pl' => '<p><span style="font-family: sans-serif;"><strong>Hi </strong>{reimbursement_employee}</span></p>
                    <p><span style="font-family: sans-serif;"><strong>Temat umowy:</strong> {reimbursement_subject} </span></p>
                    <p><strong><span style="font-family: sans-serif;"><span style="font-family: sans-serif;">S</span></span></strong><span style="font-family: sans-serif;"><strong>data tartu</strong>: {reimbursement_start_date} </span></p>
                    <p><span style="font-family: sans-serif;"><strong>Data zakończenia</strong>: {reimbursement_end_date} </span></p>
                    <p><span style="font-family: sans-serif;">Nie można się doczekać, aby usłyszeć od użytkownika. </span></p>
                    <p><strong><span style="font-family: sans-serif;">Regaty typu, </span></strong></p>
                    <p><span style="font-family: sans-serif;">{app_name}</span></p>',
                    'ru' => '<p><span style="font-family: sans-serif;"><strong>Привет </strong>{ reimbursement_employee } </span></p>
                    <p><span style="font-family: sans-serif;"><strong>Тема договора:</strong> { reimbursement_subject } </span></p>
                    <p><strong><span style="font-family: sans-serif;">S</span></strong><span style="font-family: sans-serif;"><strong>дата запуска</strong>: { reimbursement_start_date } </span></p>
                    <p><span style="font-family: sans-serif;"><strong>Дата окончания</strong>: { reimbursement_end_date } </span></p>
                    <p><span style="font-family: sans-serif;">С нетерпением ожидаю услышать от вас. </span></p>
                    <p><strong><span style="font-family: sans-serif;">Карты вида, </span></strong></p>
                    <p><span style="font-family: sans-serif;">{app_name}</span></p>',
                    'pt' => '<p><span style="font-family: sans-serif;"><strong>Oi </strong>{reimbursement_employee} </span></p>
                    <p><span style="font-family: sans-serif;"><strong>Assunto do Contrato:</strong> {reimbursement_subject} </span></p>
                    <p><strong><span style="font-family: sans-serif;">S</span></strong><span style="font-family: sans-serif;"><strong>tart Date</strong>: {reimbursement_start_date} </span></p>
                    <p><span style="font-family: sans-serif;"><strong>Data de término</strong>: {reimbursement_end_date} </span></p>
                    <p><span style="font-family: sans-serif;">Olhando para a frente para ouvir de você. </span></p>
                    <p><strong><span style="font-family: sans-serif;">Kind Considerar, </span></strong></p>
                    <p><span style="font-family: sans-serif;">{app_name}</span></p>',
                    'tr' => '<p><span style="font-family: sans-serif;"><strong>MERHABA </strong>{reimbursement_employee} </span></p>
                    <p><span style="font-family: sans-serif;"><strong>Sözleşme Konusu:</strong> {reimbursement_subject} </span></p>
                    <p><strong><span style="font-family: sans-serif;">S</span></strong><span style="font-family: sans-serif;"><strong>Başlangıç ​​tarihi</strong>: {reimbursement_start_date} </span></p>
                    <p><span style="font-family: sans-serif;"><strong>Bitiş tarihi</strong>: {reimbursement_end_date} </span></p>
                    <p><span style="font-family: sans-serif;">senden haber bekliyorum. </span></p>
                    <p><strong><span style="font-family: sans-serif;">Saygılarımla, </span></strong></p>
                    <p><span style="font-family: sans-serif;">{app_name}</span></p>',
                    'zh' => '<p><span style="font-family: sans-serif;"><strong>你好 </strong>{reimbursement_employee} </span></p>
                    <p><span style="font-family: sans-serif;"><strong>合同主体:</strong> {reimbursement_subject} </span></p>
                    <p><strong><span style="font-family: sans-serif;"></span></strong><span style="font-family: sans-serif;"><strong>开始日期</strong>: {reimbursement_start_date} </span></p>
                    <p><span style="font-family: sans-serif;"><strong>结束日期</strong>: {reimbursement_end_date} </span></p>
                    <p><span style="font-family: sans-serif;">期待着听到您的意见. </span></p>
                    <p><strong><span style="font-family: sans-serif;">亲切的问候, </span></strong></p>
                    <p><span style="font-family: sans-serif;">{app_name}</span></p>',
                    'he' => '<p><span style="font-family: sans-serif;"><strong>היי </strong>{reimbursement_employee} </span></p>
                    <p><span style="font-family: sans-serif;"><strong>נושא החוזה:</strong> {reimbursement_subject} </span></p>
                    <p><strong><span style="font-family: sans-serif;"></span></strong><span style="font-family: sans-serif;"><strong>תאריך התחלה</strong>: {reimbursement_start_date} </span></p>
                    <p><span style="font-family: sans-serif;"><strong>תאריך סיום</strong>: {reimbursement_end_date} </span></p>
                    <p><span style="font-family: sans-serif;">מצפה לשמוע ממך. </span></p>
                    <p><strong><span style="font-family: sans-serif;">בברכה, </span></strong></p>
                    <p><span style="font-family: sans-serif;">{app_name}</span></p>',
                    'pt-br' => '<p><span style="font-family: sans-serif;"><strong>Oi </strong>{reimbursement_employee} </span></p>
                    <p><span style="font-family: sans-serif;"><strong>Assunto do Contrato:</strong> {reimbursement_subject} </span></p>
                    <p><strong><span style="font-family: sans-serif;">S</span></strong><span style="font-family: sans-serif;"><strong>tart Date</strong>: {reimbursement_start_date} </span></p>
                    <p><span style="font-family: sans-serif;"><strong>Data de término</strong>: {reimbursement_end_date} </span></p>
                    <p><span style="font-family: sans-serif;">Olhando para a frente para ouvir de você. </span></p>
            ...
            'ticket_notification' => [
                ...
                'lang' => [
                    'en' => '<p ><b>Subject:-Hay! A new Ticket Has been Raised by  {ticket_name}</b></p>
                    <p >Hope this email ﬁnds you well! , {ticket_name} ticket code is {ticket_code}. </p></br>
                    {ticket_description},
                    <p >Kindly do Resolve the Raised Ticket Query If You Can.</p></br>
                    <p><b>Thank you</b></p>
                    <p><b>Regards,</b></p>
                    <p><b>,</b></p>
                    <p><b>{app_name}</b></p>',
    ...
    public function reimbursementNumberFormat($number)
    {
        $settings = Utility::settings();

        return $settings["reimbursement_prefix"] . sprintf("%05d", $number);
    }
