...
class TravelController extends Controller
{
    public function index()
    {
        if(\Auth::user()->can('Manage Travel'))
        {
            ...
            elseif(\Auth::user()->type == 'manager'){
                ...
                return view('travel.index', compact('travels','managerDepartmentId', 'managerBranchId'));
            }
            else
            {
                $travels = Travel::where('created_by', '=', \Auth::user()->creatorId())->get();
    ...
    public function edit(Travel $travel)
    {
        ...
        {
            $employees = Employee::where('created_by', \Auth::user()->creatorId())->where('id','=',$travel->employee_id)->get()->pluck('name', 'id');
