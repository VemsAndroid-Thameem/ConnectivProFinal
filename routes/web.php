...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::group(
        ...
        function () {
            ...
            Route::post('teams-settings', [SettingsController::class, 'saveTeamsSettings'])->name('teams.settings'); //get teams webhook url
    ...
    //two way
    Route::post('appraisal/changeshow', [AppraisalController::class, 'changeshow'])->name('appraisal.changeshow')->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    // Route::get('reimbursement', ReimbursementController::class)->middleware(['auth', 'XSS']);
    Route::resource('reimbursement_type', ReimbursementTypeController::class)->middleware(['auth', 'XSS']);
    Route::resource('reimbursement', ReimbursementController::class)->middleware(['auth', 'XSS']);
    Route::post('/reimbursement_status_edit/{id}', [ReimbursementController::class, 'reimbursement_status_edit'])->name('reimbursement.status')->middleware(['auth', 'XSS']);
    Route::post('/reimbursement/{id}/file', [ReimbursementController::class, 'fileUpload'])->name('reimbursements.file.upload')->middleware(['auth', 'XSS']);
    Route::get('/reimbursement/{id}/file/{fid}',  [ReimbursementController::class, 'fileDownload'])->name('reimbursements.file.download')->middleware(['auth', 'XSS']);
    Route::get('/reimbursement/{id}/file/delete/{fid}', [ReimbursementController::class, 'fileDelete'])->name('reimbursements.file.delete')->middleware(['auth', 'XSS']);
    Route::post('/reimbursement/{id}/notestore', [ReimbursementController::class, 'noteStore'])->name('reimbursements.note.store')->middleware(['auth']);
    Route::get('/reimbursement/{id}/note', [ReimbursementController::class, 'noteDestroy'])->name('reimbursements.note.destroy')->middleware(['auth']);

    Route::post('reimbursement/{id}/description', [ReimbursementController::class, 'descriptionStore'])->name('reimbursements.description.store')->middleware(['auth']);


    Route::post('/reimbursement/{id}/commentstore', [ReimbursementController::class, 'commentStore'])->name('comment.store');
    Route::get('/reimbursement/{id}/comment', [ReimbursementController::class, 'commentDestroy'])->name('comment.destroy');


    Route::get('/reimbursement/copy/{id}', [ReimbursementController::class, 'copyreimbursement'])->name('reimbursements.copy')->middleware(['auth', 'XSS']);
    Route::post('/reimbursement/copy/store/{id}', [ReimbursementController::class, 'copyreimbursementstore'])->name('reimbursements.copystore')->middleware(['auth', 'XSS']);

    Route::get('reimbursement/{id}/get_reimbursement', [ReimbursementController::class, 'printReimbursement'])->name('get.reimbursement');
    Route::get('reimbursement/pdf/{id}', [ReimbursementController::class, 'pdffromreimbursement'])->name('reimbursement.download.pdf');

    // Route::get('/signature/{id}', 'ReimbursementController@signature')->name('signature')->middleware(['auth','XSS']);
    // Route::post('/signaturestore', 'ReimbursementController@signatureStore')->name('signaturestore')->middleware(['auth','XSS']);

    Route::get('/reimbursement/{id}/mail', [ReimbursementController::class, 'sendmailReimbursement'])->name('send.mail.reimbursement');
    Route::get('/signature/{id}', [ReimbursementController::class, 'signature'])->name('signature')->middleware(['auth', 'XSS']);
    Route::post('/signaturestore', [ReimbursementController::class, 'signatureStore'])->name('signaturestore')->middleware(['auth', 'XSS']);
