...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item mt-2">{{ __('Timesheet') }}</li>
@endsection
                ...
                <div class="card-body py-0">
                    <div class="table-responsive">
                        <table class="table" id="pc-dt-simple">
                            ...
                            $employee = Employee::where('user_id', '=', $timeSheet->employee_id)->first(); // Use first() instead of get()

$timeSheetDepartmentId = !empty($employee->department_id) ? $employee->department_id : null;
$timeSheetBranchId = !empty($employee->branch_id) ? $employee->branch_id : null;
$belongsToManagerDepartment = ((int)$timeSheetDepartmentId === (int)$managerDepartmentId);
$belongsToManagerBranch = ((int)$timeSheetBranchId === (int)$managerBranchId);


                            \Log::info('timeSheetDepartmentId: '.$timeSheetDepartmentId .' timeSheetBranchId: '.$timeSheetBranchId);
