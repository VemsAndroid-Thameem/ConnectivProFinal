...
<div class="col-md-6">
    <div class="form-group">
        ...
        <div class="department_div">
            <select class="form-control select2 department_id" id="department_id" name="department_id[]" placeholder="Select Department" required>
            <option value="">{{ __('Select Department') }}</option>
                <option value="0">{{ __('All Employee') }}</option>
            </select>
        </div>
    </div>
</div>
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <div class="employee_div">
            <select class="form-control select2 employee_id" name="employee_id[]" id="employee_id" multiple>
