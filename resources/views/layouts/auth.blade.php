        ...
        <div class="auth-content">
            <nav class="navbar navbar-expand-md navbar-light default">
                <div class="container-fluid pe-2">
                    <a class="navbar-brand" href="https://connectiv.vemsgroup.in/">
                    ...
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo01" style="flex-grow: 0;">
                        <ul class="navbar-nav align-items-center ms-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link" href="pages/about_us">{{ __('About Us') }}</a>
                            </li>&nbsp|
                            <li class="nav-item">
                                <a class="nav-link" href="pages/terms_and_conditions">{{ __('Terms & conditions') }}</a>
                            </li>&nbsp|
                            <li class="nav-item">
                                <a class="nav-link" href="pages/privacy_policy">{{ __('Privacy policy') }}</a>
                            </li>
                            <li class="nav-item">
                                @yield('language-bar')
                            </li>
