...
<head>
    ...
    <title>
        {{ Utility::getValByName('title_text') ? Utility::getValByName('title_text') : config('app.name', 'Connectiv') }}
    ...
    <meta name="author" content="Vemsgroup" />
...
<body class="{{ $color }}">
    ...
    <!-- Floating Chat -->
    <div>
        <!-- <a href="https://api.whatsapp.com/send?phone=8610794156&text=Hola%21%20Quisiera%20m%C3%A1s%20informaci%C3%B3n%20sobre%20Varela%202." class="float" target="_blank" style="position:fixed; -->
        <!-- <a href="{{ route('chats') }}" class="floatchat" style="position: fixed;width: 60px;height: 60px;bottom: 40px;right: 40px;background-color: #0000;color: #FFF;border-radius: 50px;text-align: center;font-size: 30px;box-shadow: 2px 2px 3px #999;z-index: 100;"> -->

        <!-- Floating Chat Icon -->
        <!-- <a href="{{ route('chats') }}" class="floatchat">
            <i class="far fa-comments" style="margin-top:16px;"></i>
        </a> -->
    </div>
    <!-- [ Main Content ] end -->
...
<![endif]-->
    ...
    <script src="https://cdn.jsdelivr.net/npm/lucide-icons-svelte@0.1.0/index.min.js"></script>
<!-- Production version -->
    ...
    custdarklayout.addEventListener("click", function() {
        if (custdarklayout.checked) {
            ...
            document
                ...
                .setAttribute("src", "{{ asset('/storage/uploads/logo/light_logo.png') }}");
        } else {
            document
                .querySelector("#main-style-link")
            ...
            document
                .querySelector(".m-header > .b-brand > .logo-lg")
                .setAttribute("src", "{{ asset('/storage/uploads/logo/dark_logo.png') }}");
        }
    });
