<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        @can('Manage Reimbursement Type')
            <a href="{{ route('reimbursement_type.index') }}"
                class="list-group-item list-group-item-action border-0 {{ request()->is('reimbursement_type*') ? 'active' : '' }}">{{ __('Reimbursement Type') }}
                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
            </a>
        @endcan
