...
<head>
    {{-- <title>{{ __('Connectiv') }}</title> --}}
    <title>
        {{ App\Models\Utility::getValByName('title_text') ? App\Models\Utility::getValByName('title_text') : config('app.name', 'Connectiv ') }}
    </title>
    ...
    <meta property="og:image"
        content="{{ isset($meta_logo) && !empty(asset('storage/uploads/meta/' . $meta_logo)) ? asset('storage/uploads/meta/' . $meta_logo) : 'connectiv.png' }}">
    ...
    <meta name="author" content="Vems Business Services" />
...
<body class="{{ $color }}">
        ...
        <div class="container">
            <a class="navbar-brand bg-transparent" href="#">
                ...
                {{-- <img src="{{ $logos . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'light_logo.png') }}"
                    alt="{{ config('app.name', 'connectiv') }}" alt="logo"> --}}
                ...
                <div class="col-sm-5">
                    ...
                    <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                        <a href="{{ route('login') }}" class="btn btn-light me-2"><i
                            ...
                            Demo</a>
                        <a href="https://connectiv.vemsgroup.in"
    ...
    <section id="dashboard" class="theme-alt-bg dashboard-block">
        <div class="container">
            ...
            <img src="{{ asset('landing/connectiv.png') }}" alt=""
    ...
    <section class="">
        <div class="container">
            <div class="row align-items-center justify-content-end mb-5">
                ...
                <div class="col-sm-6">
                    <img src="{{ asset('landing/connectiv.png') }}" alt="Datta Able Admin Template"
                        class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.2s" />
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-12 text-end">
                    ...
                    {{-- <p class="text-body"> {{ __('Copyright') }} &copy;
                        {{ Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'Connectiv') }}
                        {{ date('Y') }} </p> --}}
                    <p class="text-body">&copy;{{ __('Copyright') }}
                        {{ Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'connectiv SaaS') }}
                        {{ date('Y') }} | Design By connectiv </p>
                </div>
            </div>
        </div>
