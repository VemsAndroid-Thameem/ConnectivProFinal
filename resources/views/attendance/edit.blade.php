...
<div class="row">
    ...
    @if($isRemoteFetch[0]['isRemote']==='1')
    <div class="form-group col-lg-6 col-md-6">
        {{ Form::label('remote_status', __('Remote Status'), ['class' => 'col-form-label']) }}
        {{ Form::select('remote_status', ['Pending' => 'Pending', 'Approved' => 'Approved', 'Not approved' => 'Not approved'], null, ['class' => 'form-control select2']) }}
    </div>
    @endif
</div>
</div>
