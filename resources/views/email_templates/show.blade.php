                            ...
                            <li class="dropdown dash-h-item drp-language">
                                ...
                                <div class="dropdown-menu dash-h-dropdown dropdown-menu-end" aria-labelledby="dropdownLanguage">
                                    ...
                                    <a href="{{ route('manage.email.language', [$EmailTemplate->id, Request::segment(3) ? Request::segment(3) : \Auth::user()->lang]) }}"
                                        class="dropdown-item {{ $emailTemplate->name == $EmailTemplate->name ? 'text-primary' : '' }}">{{
                                        $EmailTemplate->name }}
                                    </a>
                                    @endforeach
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card">
                            <div class="card-header card-body">
                                ...
                                @elseif($emailTemplate->slug == 'ticket_notification')
                                        <div class="row">
                                            {{-- <h6 class="font-weight-bold pb-3">{{__('Ticket Create')}}</h6> --}}
                                            <p class="col-4">{{ __('App Name') }} : <span
                                                    class="pull-end text-primary">{app_name}</span></p>
                                    ...
                                    @elseif($emailTemplate->slug == 'contract')
                                        ...
                                        @elseif($emailTemplate->slug == 'reimbursement')
                                        <div class="row">
                                            {{-- <h6 class="font-weight-bold pb-3">{{__('Reimbursement')}}</h6> --}}
                                            <p class="col-4">{{ __('Reimbursement Subject') }} : <span
                                                    class="pull-right text-primary">{reimbursement_subject}</span></p>
                                            <p class="col-4">{{ __('Reimbursement Employee') }} : <span
                                                    class="pull-right text-primary">{reimbursement_employee}</span></p>
                                            <p class="col-4">{{ __('Reimbursement Start Date') }} : <span
                                                    class="pull-right text-primary">{reimbursement_start_date}</span></p>
                                            <p class="col-4">{{ __('Reimbursement End Date') }} : <span
                                                    class="pull-right text-primary">{reimbursement_end_date}</span></p>
                                                    <p class="col-4">{{ __('App Name') }} : <span
                                                    class="pull-right text-primary">{app_name}</span></p>
                                        </div>
                                    @endif
