	...
	<style>
	  @media (max-width: 680px) {
		.messenger-listView .m-body {
		  margin-top: 73px; /* Adjust this value as needed for mobile responsiveness */
		}
	  }
	</style>
            ...
            <div class="messenger rounded min-h-750 overflow-hidden">
                ...
                <div class="messenger-listView">
                    ...
                    <div class="m-header">
                        ...
                        <!-- If You try to uncomment this you ave to change the css margin as well -->
                        <!-- {{-- Tabs --}}
                    ...
                    {{-- tabs and lists --}}
                    <div class="m-body" style="margin-top: 73px">
                        {{-- Lists [Users/Group] --}}
                        {{-- ---------------- [ User Tab ] ---------------- --}}
