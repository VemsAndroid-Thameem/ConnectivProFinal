...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item mt-2">{{ __('Manage Monthly Attendance Report') }}</li>
@endsection
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    ...
                                    <div>
                                        <!-- included remote count -->
                                        <p class="text-muted text-sm mb-0">{{ __('Total present') }}:
                                            {{ $data['totalPresent'] }} ( {{__('Remote')}} : {{$data['totalRemote']}})</p>
                                        <!-- <p class="text-muted text-sm mb-0">{{ __('Total leave') }}:
                                            {{ $data['totalLeave'] }}</p> comment out this-->
                                    </div>
                                ...
                                @foreach ($employeesAttendance as $attendance)
                                    <tr>
                                        ...
                                        <td>
                                                ...
                                                @elseif($status == 'R')
                                                    <i class="badge bg-info p-2 rounded">{{ __('R') }}</i>  <!-- remote login -->    
                                                @elseif($status == '')
                                                    <i class="badge bg-light p-2 rounded">{{ __('X') }}</i>  <!-- remote login -->                                              
                                                @else($status == 'A')
