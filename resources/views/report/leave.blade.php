...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item mt-2">{{ __('Leave Report') }}</li>
@endsection
@push('script-page')
                    ...
                    <div class="card-body p-3">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <h5 class="mb-0">{{ __('Reviewed Leaves') }}</h5>
                                    <p class="text-muted text-sm mb-0">{{ $filter['totalReviewed'] }}</p>
                                </div>
                            </div>
                        ...
                        <tbody>
                            @foreach ($leaves as $leave)
                                <tr>
                                    ...
                                    <td>
                                        <div class="m-view-btn btn btn-sm btn-info rounded">
                                            {{ $leave['reviewed'] }}
                                            <a href="#" class="text-white"
                                                data-url="{{ route('report.employee.leave', [$leave['id'], 'Reviewed', isset($_GET['type']) ? $_GET['type'] : 'no', isset($_GET['month']) ? $_GET['month'] : date('Y-m'), isset($_GET['year']) ? $_GET['year'] : date('Y')]) }}"
                                                class="table-action table-action-delete" data-size="lg"
                                                data-ajax-popup="true" data-title="{{ __('Reviewed Leave Detail') }}"
                                                data-bs-toggle="tooltip" title="{{ __('View') }}"
                                                data-original-title="{{ __('View') }}">{{ __('View') }}</a>
                                        </div>
                                    </td>
