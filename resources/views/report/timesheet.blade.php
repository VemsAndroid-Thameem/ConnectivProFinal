...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item mt-2">{{ __('Manage Timesheet Report') }}</li>
@endsection
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                    ...
                                    <div class="btn-box" id="department_id">
                                        {{ Form::label('department', __('Department'), ['class' => 'form-label']) }}
                                        <select class="form-control select department_id" name="department" id="department_id" placeholder="Select Department">
                                        </select>
                                    </div>
