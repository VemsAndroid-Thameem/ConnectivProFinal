    ...
    <li class="nav-item">
        ...
        @endforeach --}}
            @foreach (App\Models\Utility::languages() as $code => $language)
                <option @if ($lang == $code) selected @endif value="{{ route('login', $code) }}">
                    ...
                    <div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="password-container" style="position: relative;">
                                ...
                                <i class="password-toggle-icon fas fa-eye" id="password-toggle" style="position: absolute; top: 50%; right: 10px; transform: translateY(-50%); cursor: pointer;"></i>
                            </div>
                            @error('password')
                        ...
                        <div class="d-grid">
                            <button type="submit" class="login-do-btn btn btn-primary btn-block mt-2"
                                tabindex="4" id="login_button">{{ __('Login') }}</button>
                        </div>
