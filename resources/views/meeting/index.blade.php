        ...
        function getEmployee(did) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    console.log(data);
                    $('.employee_id').empty();
                    var empl_selct = `<select class="employee_id form-control multi-select" id="choices-multiple" multiple="" required="required" name="employee_id[]">
                    </select>`;
                    $('.employee_div').html(empl_selct);
