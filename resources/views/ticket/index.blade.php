                ...
                <div class="table-responsive">
                    <table class="table" id="pc-dt-simple">
                        ...
                        <tbody>
                            ...
                            $employee = Employee::where('user_id', '=', $ticket->employee_id)->first(); // Use first() instead of get()

$ticketDepartmentId = !empty($employee->department_id) ? $employee->department_id : null;
$ticketBranchId = !empty($employee->branch_id) ? $employee->branch_id : null;
$belongsToManagerDepartment = ((int)$ticketDepartmentId === (int)$managerDepartmentId);
$belongsToManagerBranch = ((int)$ticketBranchId === (int)$managerBranchId);


                            \Log::info('ticketDepartmentId: '.$ticketDepartmentId .' ticketBranchId: '.$ticketBranchId);
