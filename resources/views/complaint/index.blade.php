                ...
                <div class="table-responsive">
                    <table class="table" id="pc-dt-simple">
                        ...
                        <tbody>
                            ...
                            $employee = Employee::where('id', '=', $complaint->complaint_from)->first(); // Use first() instead of get()

$complaintDepartmentId = !empty($employee->department_id) ? $employee->department_id : null;
$complaintBranchId = !empty($employee->branch_id) ? $employee->branch_id : null;
$belongsToManagerDepartment = ((int)$complaintDepartmentId === (int)$managerDepartmentId);
$belongsToManagerBranch = ((int)$complaintBranchId === (int)$managerBranchId);


                            \Log::info('complaintDepartmentId: '.$complaintDepartmentId .' complaintBranchId: '.$complaintBranchId);
