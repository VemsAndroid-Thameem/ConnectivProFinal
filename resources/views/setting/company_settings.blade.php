    ...
    <div class="col-sm-12">
        <div class="row">
            <div class="col-xl-3">
                <div class="card sticky-top">
                    <div class="list-group list-group-flush" id="useradd-sidenav">
                        ...
                        <a href="#teams-settings" id="teams-setting-tab"
                            class="list-group-item list-group-item-action border-0">{{ __('Teams Settings') }} <div
                                class="float-end"><i class="ti ti-chevron-right"></i></div></a>
            ...
            <div class="col-xl-9">
                                                ...
                                                <div class="form-group ml-2 mr-3">
                                                    ...
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" data-toggle="switchbutton"
                                                            ...
                                                            {{ $settings['display_landing_page'] == 'off' ? 'checked="checked"' : '' }}>
                ...
                <div class="" id="teams-settings">
                    {{ Form::open(['route' => 'teams.settings', 'method' => 'post']) }}
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5>{{ __('Teams Settings') }}</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <!-- <div class="col-lg-4 col-md-6 col-sm-6 form-group">
                                            {{ Form::label('teams_channel_webhook_url', __('Teams Channel Webhook URL'), ['class' => 'col-form-label']) }}
                                            {{ Form::text('teams_channel_webhook_url', env('TEAMS_CHANNEL_WEBHOOK_URL'), ['class' => 'form-control', 'placeholder' => __('Enter Teams Channel Webhook URL')]) }}
                                            @error('teams_channel_webhook_url')
                                                <span class="text-xs text-danger invalid-teams_channel_webhook_url"
                                                    role="alert">{{ $message }}</span>
                                            @enderror
                                        </div> -->
                                        <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                            <label for="teams_channel_webhook_url"
                                                class="col-form-label">{{ __('Teams Channel Webhook URL') }}                                    <small class="text-xs">
(for chat messaging notifications)</small></label>
                                            <input class="form-control" placeholder="Enter Teams Channel Webhook URL"
                                                name="teams_channel_webhook_url" type="text" value="{{ env('TEAMS_CHANNEL_WEBHOOK_URL') }}"
                                                id="teams_channel_webhook_url">
                                                @error('teams_channel_webhook_url')
                                                <span class="text-xs text-danger invalid-teams_channel_webhook_url"
                                                    role="alert">{{ $message }}</span>
                                            @enderror
				...
				{{-- End of comment (removed telegram) --}}
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="setting-card">
                                    <div class="logo-content">
                                        <img id="image2"
                                            src="{{ $meta_image . '/' . (isset($setting['meta_image']) && !empty($setting['meta_image']) ? $setting['meta_image'] : 'connectiv.png') }}"
