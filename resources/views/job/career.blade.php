    ...
    <div class="job-wrapper">
        <div class="job-content">
            ...
            <section class="placedjob-section">
                <div class="container">
                    <div class="section-title bg-dark text-light mb-3">
                        @php
                            $totaljob = \App\Models\Job::where('created_by', '=', $id)->count();
                        @endphp

                        <h2 class="h1 mb-3 text-light"> <span class="text-primary">+{{ $totaljob }}
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 job-card">
                                <div class="job-card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <a href="{{ route('job.requirement', [$job->code, !empty($job) ? (!empty($job->createdBy->lang) ? $job->createdBy->lang : 'en') : 'en']) }}"
                                               class="btn btn-primary w-100 mt-4 copyLink"><i class="fas fa-copy"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
